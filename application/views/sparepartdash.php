              ...
              <tbody>
                ...
                foreach($record as $r)
                {
                  ...
                  <tr>
                    ...
                    <td width="150">
                      <a href="<?= base_url('sparepart/edit/' . $r->id_sparepart) ?>" > <span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> Edit &nbsp;</a>
                      <a href="<?= base_url('sparepart/delete/' . $r->id_sparepart) ?>" > <span class="glyphicon glyphicon-remove" aria-hidden="true"></span> Delete </a>
